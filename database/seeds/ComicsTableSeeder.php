...
class ComicsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($fumetti as $ele){
            $newfumetto = new Comic();

            $newfumetto->title=$ele['title'];
            $newfumetto->description=$ele['description'];
            $newfumetto->thumb=$ele['thumb'];
            $newfumetto->price=$ele['price'];
            $newfumetto->series=$ele['series'];
            $newfumetto->sale_date=$ele['sale_date'];
            $newfumetto->type=$ele['type'];
